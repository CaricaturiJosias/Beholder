...
#ifndef SOAP_TYPE___ns1__hello_DEFINED
#define SOAP_TYPE___ns1__hello_DEFINED
...
SOAP_FMAC3 struct __ns1__hello * SOAP_FMAC4 soap_new___ns1__hello(struct soap *soap, int n);
...
#define soap_write___ns1__hello(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___ns1__hello(soap, data), 0) || soap_put___ns1__hello(soap, data, "-ns1:hello", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT___ns1__hello
#define soap_PUT___ns1__hello(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___ns1__hello(soap, data), 0) || soap_put___ns1__hello(soap, data, "-ns1:hello", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH___ns1__hello
#define soap_PATCH___ns1__hello(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___ns1__hello(soap, data), 0) || soap_put___ns1__hello(soap, data, "-ns1:hello", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send___ns1__hello
#define soap_POST_send___ns1__hello(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___ns1__hello(soap, data), 0) || soap_put___ns1__hello(soap, data, "-ns1:hello", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif
...
#define soap_read___ns1__hello(soap, data) ( ((data) ? (soap_default___ns1__hello(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get___ns1__hello(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET___ns1__hello
#define soap_GET___ns1__hello(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read___ns1__hello(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv___ns1__hello
#define soap_POST_recv___ns1__hello(soap, data) ( soap_read___ns1__hello(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE__ns2__helloResponse_DEFINED
#define SOAP_TYPE__ns2__helloResponse_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default__ns2__helloResponse(struct soap*, struct _ns2__helloResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize__ns2__helloResponse(struct soap*, const struct _ns2__helloResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns2__helloResponse(struct soap*, const char*, int, const struct _ns2__helloResponse *, const char*);
SOAP_FMAC3 struct _ns2__helloResponse * SOAP_FMAC4 soap_in__ns2__helloResponse(struct soap*, const char*, struct _ns2__helloResponse *, const char*);

SOAP_FMAC3 struct _ns2__helloResponse * SOAP_FMAC4 soap_new__ns2__helloResponse(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put__ns2__helloResponse(struct soap*, const struct _ns2__helloResponse *, const char*, const char*);

#ifndef soap_write__ns2__helloResponse
#define soap_write__ns2__helloResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize__ns2__helloResponse(soap, data), 0) || soap_put__ns2__helloResponse(soap, data, "ns2:helloResponse", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT__ns2__helloResponse
#define soap_PUT__ns2__helloResponse(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__helloResponse(soap, data), 0) || soap_put__ns2__helloResponse(soap, data, "ns2:helloResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH__ns2__helloResponse
#define soap_PATCH__ns2__helloResponse(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__helloResponse(soap, data), 0) || soap_put__ns2__helloResponse(soap, data, "ns2:helloResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send__ns2__helloResponse
#define soap_POST_send__ns2__helloResponse(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__helloResponse(soap, data), 0) || soap_put__ns2__helloResponse(soap, data, "ns2:helloResponse", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct _ns2__helloResponse * SOAP_FMAC4 soap_get__ns2__helloResponse(struct soap*, struct _ns2__helloResponse *, const char*, const char*);

#ifndef soap_read__ns2__helloResponse
#define soap_read__ns2__helloResponse(soap, data) ( ((data) ? (soap_default__ns2__helloResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get__ns2__helloResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET__ns2__helloResponse
#define soap_GET__ns2__helloResponse(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read__ns2__helloResponse(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv__ns2__helloResponse
#define soap_POST_recv__ns2__helloResponse(soap, data) ( soap_read__ns2__helloResponse(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE__ns2__hello_DEFINED
#define SOAP_TYPE__ns2__hello_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default__ns2__hello(struct soap*, struct _ns2__hello *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize__ns2__hello(struct soap*, const struct _ns2__hello *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns2__hello(struct soap*, const char*, int, const struct _ns2__hello *, const char*);
SOAP_FMAC3 struct _ns2__hello * SOAP_FMAC4 soap_in__ns2__hello(struct soap*, const char*, struct _ns2__hello *, const char*);

SOAP_FMAC3 struct _ns2__hello * SOAP_FMAC4 soap_new__ns2__hello(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put__ns2__hello(struct soap*, const struct _ns2__hello *, const char*, const char*);

#ifndef soap_write__ns2__hello
#define soap_write__ns2__hello(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize__ns2__hello(soap, data), 0) || soap_put__ns2__hello(soap, data, "ns2:hello", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT__ns2__hello
#define soap_PUT__ns2__hello(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__hello(soap, data), 0) || soap_put__ns2__hello(soap, data, "ns2:hello", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH__ns2__hello
#define soap_PATCH__ns2__hello(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__hello(soap, data), 0) || soap_put__ns2__hello(soap, data, "ns2:hello", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send__ns2__hello
#define soap_POST_send__ns2__hello(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__hello(soap, data), 0) || soap_put__ns2__hello(soap, data, "ns2:hello", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct _ns2__hello * SOAP_FMAC4 soap_get__ns2__hello(struct soap*, struct _ns2__hello *, const char*, const char*);

#ifndef soap_read__ns2__hello
#define soap_read__ns2__hello(soap, data) ( ((data) ? (soap_default__ns2__hello(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get__ns2__hello(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET__ns2__hello
#define soap_GET__ns2__hello(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read__ns2__hello(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv__ns2__hello
#define soap_POST_recv__ns2__hello(soap, data) ( soap_read__ns2__hello(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif
...
#ifndef SOAP_TYPE_PointerTo_ns2__helloResponse_DEFINED
#define SOAP_TYPE_PointerTo_ns2__helloResponse_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns2__helloResponse(struct soap*, struct _ns2__helloResponse *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns2__helloResponse(struct soap*, const char *, int, struct _ns2__helloResponse *const*, const char *);
SOAP_FMAC3 struct _ns2__helloResponse ** SOAP_FMAC4 soap_in_PointerTo_ns2__helloResponse(struct soap*, const char*, struct _ns2__helloResponse **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns2__helloResponse(struct soap*, struct _ns2__helloResponse *const*, const char*, const char*);
SOAP_FMAC3 struct _ns2__helloResponse ** SOAP_FMAC4 soap_get_PointerTo_ns2__helloResponse(struct soap*, struct _ns2__helloResponse **, const char*, const char*);
#endif

#ifndef SOAP_TYPE_PointerTo_ns2__hello_DEFINED
#define SOAP_TYPE_PointerTo_ns2__hello_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns2__hello(struct soap*, struct _ns2__hello *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns2__hello(struct soap*, const char *, int, struct _ns2__hello *const*, const char *);
SOAP_FMAC3 struct _ns2__hello ** SOAP_FMAC4 soap_in_PointerTo_ns2__hello(struct soap*, const char*, struct _ns2__hello **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns2__hello(struct soap*, struct _ns2__hello *const*, const char*, const char*);
SOAP_FMAC3 struct _ns2__hello ** SOAP_FMAC4 soap_get_PointerTo_ns2__hello(struct soap*, struct _ns2__hello **, const char*, const char*);
#endif
